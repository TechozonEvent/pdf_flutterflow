...
import 'mergepdf_model.dart';
export 'mergepdf_model.dart';

class MergepdfWidget extends StatefulWidget {
  const MergepdfWidget({super.key});

  @override
  State<MergepdfWidget> createState() => _MergepdfWidgetState();
}

class _MergepdfWidgetState extends State<MergepdfWidget> {
  late MergepdfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MergepdfModel());
  }
