...
import 'compress_pdf_copy_model.dart';
export 'compress_pdf_copy_model.dart';

class CompressPdfCopyWidget extends StatefulWidget {
  const CompressPdfCopyWidget({super.key});

  @override
  State<CompressPdfCopyWidget> createState() => _CompressPdfCopyWidgetState();
}

class _CompressPdfCopyWidgetState extends State<CompressPdfCopyWidget> {
  late CompressPdfCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompressPdfCopyModel());
  }
